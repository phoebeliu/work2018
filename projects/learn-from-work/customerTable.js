...
(function() {
    ...
    angular.module("customerEdge.angular.table", []);
    ...
    angular.module("customerEdge.angular.table").directive("atPaginationNew", [
        function() {
            return {
                restrict: "E",
                scope: true,
    ...
    angular.module("customerEdge.angular.table").directive("atImplicitNew", [
        function() {
            return {
                restrict: "AC",
                compile: function(element, attributes, transclude) {
